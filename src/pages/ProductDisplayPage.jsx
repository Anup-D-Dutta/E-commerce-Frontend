        ...
        <div className='p-4 lg:pl-7 text-base lg:text-lg'>
            ...
            <div>
              ...
              <div className='flex items-center gap-2 lg:gap-4'>
                <div className='border border-black px-4 py-2 rounded bg-white w-fit'>
                ...
                {
                  data.discount && (
                    <p className="font-bold text-black lg:text-2xl">{data.discount}% <span className='text-base text-neutral-500'>Discount</span></p>
                  )
                }
