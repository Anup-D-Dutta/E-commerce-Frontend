  ...
  return (
    <div className='w-36 p-4 bg-white rounded'>
        ...
        <div className='grid grid-cols-2 gap-3 py-2'>
          <button onClick={()=>setEditOpen(true)} className='border px-1 py-1 text-sm border-black bg-white text-black hover:bg-green-200 rounded'>Edit</button>
          <button onClick={()=>setOpenDelete(true)} className='border px-1 py-1 text-sm border-black bg-white text-black hover:bg-red-200 rounded'>Delete</button>
        </div>
