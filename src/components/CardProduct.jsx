...
const CardProduct = ({ data }) => {
  ...
  return (
    <Link to={`/product/${valideURLConvert(data.name)}-${data._id}`} className='border-black py-2 lg:p-4 grid gap-1 lg:gap-3 min-w-36 lg:w-72 lg:min-w-52 rounded cursor-pointer bg-gray-100'>
