...
const CategoryWiseProductDisplay = ({ id, name }) => {
    ...
    return (
        <div>
            {/* Brands:- Display in home section (Hidden) */}
            <div className='container mx-auto p-4 flex items-center justify-between gap-4 '>
                <h3 className='font-semibold text-lg md:text-2xl capitalize'>{name}</h3>
                <Link to={redirectURL} className='text-black hover:text-gray-800'>See All</Link>
            </div>
